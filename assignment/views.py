    ...
    if request.method == 'POST':
        try:
            ...
            if assignment_id_str is None or assignment_id_str == '':
                return JsonResponse({'error': 'assignment_id is missing or empty'}, status=400)
            ...
            return JsonResponse({'error': 'Invalid assignment_id. It must be an integer.'}, status=400)
